...
public class SteelBlockBlock extends MinecraftUpgradePackModElements.ModElement {
	@ObjectHolder("minecraft_upgrade_pack:steel_block")
	public static final Block block = null;

	public SteelBlockBlock(MinecraftUpgradePackModElements instance) {
		super(instance, 62);
	}
