...
public class AluminiumBlockBlock extends MinecraftUpgradePackModElements.ModElement {
	@ObjectHolder("minecraft_upgrade_pack:aluminium_block")
	public static final Block block = null;

	public AluminiumBlockBlock(MinecraftUpgradePackModElements instance) {
		super(instance, 3);
	}
