...
public class TungstenBlockBlock extends MinecraftUpgradePackModElements.ModElement {
	@ObjectHolder("minecraft_upgrade_pack:tungsten_block")
	public static final Block block = null;

	public TungstenBlockBlock(MinecraftUpgradePackModElements instance) {
		super(instance, 24);
	}
