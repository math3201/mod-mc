...
public class TungstenArmorItem extends MinecraftUpgradePackModElements.ModElement {
	@ObjectHolder("minecraft_upgrade_pack:tungsten_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("minecraft_upgrade_pack:tungsten_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("minecraft_upgrade_pack:tungsten_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("minecraft_upgrade_pack:tungsten_armor_boots")
	public static final Item boots = null;

	public TungstenArmorItem(MinecraftUpgradePackModElements instance) {
		super(instance, 38);
	}
		...
		elements.items
				.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT).isImmuneToFire()) {
					...
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "minecraft_upgrade_pack:textures/models/armor/tungsten_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
					}
