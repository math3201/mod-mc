...
public class SteelIngotItem extends MinecraftUpgradePackModElements.ModElement {
	@ObjectHolder("minecraft_upgrade_pack:steel_ingot")
	public static final Item block = null;

	public SteelIngotItem(MinecraftUpgradePackModElements instance) {
		super(instance, 60);
	}
