...
public class HellstoneHoeItem extends MinecraftUpgradePackModElements.ModElement {
	@ObjectHolder("minecraft_upgrade_pack:hellstone_hoe")
	public static final Item block = null;

	public HellstoneHoeItem(MinecraftUpgradePackModElements instance) {
		super(instance, 90);
	}
